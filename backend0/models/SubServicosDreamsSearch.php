...
/**
 * SubServicosDreamsSearch represents the model behind the search form about `app\models\SubServicosDreams`.
 */
class SubServicosDreamsSearch extends SubServicosDreams
{
    /**
     * @inheritdoc
     */
