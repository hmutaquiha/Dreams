...
/**
 * ComiteCirculosSearch represents the model behind the search form about `app\models\ComiteCirculos`.
 */
class ComiteCirculosSearch extends ComiteCirculos
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'c_zona_id', 'criado_por', 'actualizado_por'], 'integer'],
