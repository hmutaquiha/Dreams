...
/**
 * ComiteCargosSearch represents the model behind the search form about `app\models\ComiteCargos`.
 */
class ComiteCargosSearch extends ComiteCargos
{
    /**
     * @inheritdoc
     */
