...
/**
 * ReferenciasServicosReferidosSearch represents the model behind the search form about `app\models\ReferenciasServicosReferidos`.
 */
class ReferenciasServicosReferidosSearch extends ReferenciasServicosReferidos
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'referencia_id', 'servico_id', 'status', 'criado_por', 'actualizado_por'], 'integer'],
