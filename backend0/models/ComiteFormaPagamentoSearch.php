...
/**
 * ComiteFormaPagamentoSearch represents the model behind the search form about `app\models\ComiteFormaPagamento`.
 */
class ComiteFormaPagamentoSearch extends ComiteFormaPagamento
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = ComiteFormaPagamento::find();
