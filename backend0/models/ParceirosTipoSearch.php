...
/**
 * ParceirosTipoSearch represents the model behind the search form about `app\models\ParceirosTipo`.
 */
class ParceirosTipoSearch extends ParceirosTipo
{
    /**
     * @inheritdoc
     */
