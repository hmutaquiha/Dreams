...
/**
 * ComiteCidadesSearch represents the model behind the search form about `app\models\ComiteCidades`.
 */
class ComiteCidadesSearch extends ComiteCidades
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'provincia_id', 'criado_por', 'actualizado_por'], 'integer'],
