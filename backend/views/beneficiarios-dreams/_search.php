...
/* @var $model app\models\BeneficiariosDreamsSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="beneficiarios-dreams-search">
    ...
    <?php // echo $form->field($model, 'house_sustainer') ?>

    <?php // echo $form->field($model, 'married_before') ?>

    <?php // echo $form->field($model, 'pregant_or_breastfeed') ?>

    <?php // echo $form->field($model, 'employed') ?>

    <?php // echo $form->field($model, 'tested_hiv') ?>

    <?php // echo $form->field($model, 'vbg_exploracao_sexual') ?>

    <?php // echo $form->field($model, 'vbg_migrante_trafico') ?>

    <?php // echo $form->field($model, 'vbg_sexual_activa') ?>

    <?php // echo $form->field($model, 'vbg_relacao_multipla') ?>

    <?php // echo $form->field($model, 'vbg_vitima') ?>
