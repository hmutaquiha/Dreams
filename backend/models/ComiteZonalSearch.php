...
/**
 * ComiteZonalSearch represents the model behind the search form about `app\models\ComiteZonal`.
 */
class ComiteZonalSearch extends ComiteZonal
{
    /**
     * @inheritdoc
     */
