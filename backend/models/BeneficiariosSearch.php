...
class BeneficiariosSearch extends Beneficiarios
{
    ...
    {
        return [
            [['id', 'emp_number','parceiro_id', 'membro_zona', 'membro_circulo','us_id', 'membro_celula', 'membro_localidade_id', 'emp_smoker', 'nation_code', 'emp_gender', 'emp_status', 'job_title_code', 'eeo_cat_code', 'work_station', 'termination_id', 'criado_por', 'actualizado_por','ponto_entrada','vbg_tempo','vbg_vsex_tempo'], 'integer'],
