...
/**
 * ServicosDreamSearch represents the model behind the search form about `app\models\ServicosDream`.
 */
class ServicosDreamSearch extends ServicosDream
{
    /**
     * @inheritdoc
     */
