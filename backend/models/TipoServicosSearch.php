...
/**
 * TipoServicosSearch represents the model behind the search form about `app\models\TipoServicos`.
 */
class TipoServicosSearch extends TipoServicos
{
    /**
     * @inheritdoc
     */
