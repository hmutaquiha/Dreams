...
/**
 * This is the model class for table "frlm_comite_celulas".
 *
 * @property integer $id
 * @property integer $c_circulo_id
 ...
 */
class ComiteCelulas extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['c_circulo_id', 'name'], 'required'],
            ['name', 'unique'],
            [['c_circulo_id', 'criado_por', 'actualizado_por'], 'integer'],
    ...
    public function attributeLabels()
    {
        return [
            'id' => 'ID',
            'c_circulo_id' => 'Comité do Circulo',
            'name' => 'Nome da Célula',
    ...
    {
        return $this->hasOne(ComiteCirculos::className(), ['id' => 'c_circulo_id']);
    }
