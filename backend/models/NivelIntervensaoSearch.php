...
/**
 * NivelIntervensaoSearch represents the model behind the search form about `app\models\NivelIntervensao`.
 */
class NivelIntervensaoSearch extends NivelIntervensao
{
    /**
     * @inheritdoc
     */
