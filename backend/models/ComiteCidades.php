 ...
 */
class ComiteCidades extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function attributeLabels()
    {
        return [
            'id' => 'ID',
            'provincia_id' => 'Comité Provincial',
            'name' => 'Cidade',
    ...
    {
        return $this->hasOne(ComiteProvincial::className(), ['id' => 'provincia_id']);
    }
