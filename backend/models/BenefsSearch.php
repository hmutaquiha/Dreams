...
/**
 * BenefsSearch represents the model behind the search form about `app\models\Benefs`.
 */
class BenefsSearch extends Benefs
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'emp_number', 'ponto_entrada', 'parceiro_id', 'via', 'idade_anos', 'estudante', 'estudante_classe', 'gravida', 'filhos', 'bairro_id', 'deficiencia', 'membro_localidade_id', 'us_id', 'membro_zona', 'membro_circulo', 'membro_celula', 'emp_smoker', 'nation_code', 'emp_gender', 'emp_status', 'job_title_code', 'eeo_cat_code', 'work_station', 'termination_id', 'criado_por', 'actualizado_por'], 'integer'],
            [['member_id', 'emp_lastname', 'emp_firstname', 'emp_middle_name', 'emp_nick_name', 'estudante_escola', 'encarregado_educacao', 'deficiencia_tipo', 'coun_code', 'provin_code', 'district_code', 'city_code', 'membro_data_admissao', 'membro_caratao_eleitor', 'membro_cargo_partido_id', 'ethnic_race_code', 'emp_birthday', 'emp_marital_status', 'emp_ssn_num', 'emp_sin_num', 'emp_other_id', 'emp_dri_lice_num', 'emp_dri_lice_exp_date', 'emp_military_service', 'emp_street1', 'emp_street2', 'emp_zipcode', 'emp_hm_telephone', 'emp_mobile', 'emp_work_telephone', 'emp_work_email', 'sal_grd_code', 'joined_date', 'emp_oth_email', 'bi', 'nuit', 'passaporte', 'dire', 'bi_data_i', 'bi_data_f', 'custom3', 'other_prof_info', 'nuit_data_i', 'nuit_data_f', 'custom7', 'custom8', 'custom9', 'custom10', 'criado_em', 'actualizado_em', 'user_location', 'user_location2'], 'safe'],
        ];
    }
