...
/**
 * OrganizacoesSearch represents the model behind the search form about `app\models\Organizacoes`.
 */
class OrganizacoesSearch extends Organizacoes
{
    ...
    public function rules()
    {
        return [
            ...
            [['name', 'abreviatura', 'description', 'criado_em', 'actualizado_em', 'user_location', 'user_location2'], 'safe'],
        ];
    }
