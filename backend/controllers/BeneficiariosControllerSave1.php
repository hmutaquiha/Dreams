...
class BeneficiariosController extends Controller
{
    ...
    public function behaviors()
    {
        ...
        'class' => AccessRule::className(),
                ...
                'rules' => [
                    [
                        'actions' => ['index','view','create','lists','listas','servicos','localidades','bairros','todos','filtros','relatorio','relatoriofy19','relatorioq1','relatorioQ2'],
...
O digitadores so visualizam 5 Beneficiarios por lista**/
    ...
    public function actionView($id)
    {
     ...
     /** 
     * Display a report for AGYW PREV 2019 By Nacarapa Reedit by Gerzelio
     * @return mixed
     * 
     */

   pubic function actionRelatoriofy19()
  {
       $model = new Beneficiarios();

       return $this->render('relatorioq', [
            'model' => $model,
       ]);
...
//added on 26.02.2019 relatorioQ1
  ...
  //added on 26.02.2019 relatorioQ1
    public function actionRelatorioQ2($id)
  {
    return $this->render('relatorioQ2', [
        'model' => $this->findModel($id),
    ]);
  }
...
//added on 11.02.2020 by Gerzelio Saide relatorioQ1
    public function actionRelatorioq1()
  {
